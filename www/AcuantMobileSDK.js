...
module.exports = {
  ...
  showManualCameraInterfaceInViewController: function(
    ...
    if (isWindows) {
      ...
      function onSuccess(imageData) {
        ...
        if (isBackSide) {
          if (cardType == 1) {
            AcuantWinRT.API.Camera.cropInsuranceCard(
              imageData,
              AcuantWinRT.API.Utils.getWidth()
          ...
          if (cardType == 3) {
            AcuantWinRT.API.Camera.cropPassport(
              imageData,
              AcuantWinRT.API.Utils.getWidth()
            ).then(function(croppedImage) {
              var data = {};
  ...
  activateLicenseKey: function(successCallback, failure, licenseKey) {
    ...
    if (isWindows) {
      var promise = AcuantWinRT.API.ActivateLicenseKey.activateLicKey(
        licenseKey
      );
  ...
  processCardImage: function(
    ...
    if (isWindows) {
      if (cardType == 1) {
        ...
        AcuantWinRT.API.MedicalInsuranceCards.processMedicalInsuranceCard().then(
          function(result) {
            ...
            data.data["reformattedImage"] = arrayBufferToBase64(
              data["data"].ReformattedImage
            );
            delete data.data.ReformattedImage;
            data.data["reformattedImageTwo"] = arrayBufferToBase64(
              data["data"].ReformattedImageTwo
            );
            delete data.data.ReformattedImageTwo;
            data.data.firstName = data.data.FirstName;
            delete data.data.FirstName;
            data.data.lastName = data.data.LastName;
            delete data.data.LastName;
            data.data.middleName = data.data.MiddleName;
            delete data.data.MiddleName;
            data.data.memberId = data.data.MemberId;
            delete data.data.MemberId;
            data.data.groupNumber = data.data.GroupNumber;
            delete data.data.GroupNumber;
            data.data.contractCode = data.data.ContractCode;
            delete data.data.ContractCode;
            data.data.copayEr = data.data.CopayEr;
            delete data.data.CopayEr;
            data.data.copayOv = data.data.CopayOv;
            delete data.data.CopayOv;
            data.data.copaySp = data.data.CopaySp;
            delete data.data.CopaySp;
            data.data.copayUc = data.data.CopayUc;
            delete data.data.CopayUc;
            data.data.coverage = data.data.Coverage;
            delete data.data.Coverage;
            data.data.dateOfBirth = data.data.DateOfBirth;
            delete data.data.DateOfBirth;
            data.data.deductible = data.data.Deductible;
            delete data.data.Deductible;
            data.data.effectiveDate = data.data.EffectiveDate;
            delete data.data.EffectiveDate;
            data.data.employer = data.data.Employer;
            delete data.data.Employer;
            data.data.expirationDate = data.data.ExpirationDate;
            delete data.data.ExpirationDate;
            data.data.groupName = data.data.GroupName;
            delete data.data.GroupName;
            data.data.issuerNumber = data.data.IssuerNumber;
            delete data.data.IssuerNumber;
            data.data.other = data.data.Other;
            delete data.data.Other;
            data.data.payerId = data.data.PayerId;
            delete data.data.PayerId;
            data.data.planAdmin = data.data.PlanAdmin;
            delete data.data.PlanAdmin;
            data.data.planProvider = data.data.PlanProvider;
            delete data.data.PlanProvider;
            data.data.planType = data.data.PlanType;
            delete data.data.PlanType;
            data.data.rxBin = data.data.RxBin;
            delete data.data.RxBin;
            data.data.rxGroup = data.data.RxGroup;
            delete data.data.RxGroup;
            data.data.rxId = data.data.RxId;
            delete data.data.RxId;
            data.data.rxPcn = data.data.RxPcn;
            delete data.data.RxPcn;
            data.data.phoneNumber = data.data.PhoneNumber;
            delete data.data.PhoneNumber;
            data.data.webAddress = data.data.WebAddress;
            delete data.data.WebAddress;
            data.data.email = data.data.Email;
            delete data.data.Email;
            data.data.fullAddress = data.data.FullAddress;
            delete data.data.FullAddress;
            data.data.city = data.data.City;
            delete data.data.City;
            data.data.zip = data.data.Zip;
            delete data.data.Zip;
            data.data.state = data.data.State;
            delete data.data.State;
        ...
        AcuantWinRT.API.IDDuplex.processIDDuplex().then(function(result) {
          ...
          data.data.licenceImage = arrayBufferToBase64(
            data.data.ReformattedImage
          );
          delete data.data.ReformattedImage;
          data.data.licenceImageTwo = arrayBufferToBase64(
            data.data.ReformattedImageTwo
          );
          delete data.data.ReformattedImageTwo;
          ...
          data.data.nameFirst = data.data.NameFirst;
          delete data.data.NameFirst;
          data.data.nameMiddle = data.data.NameMiddle;
          delete data.data.NameMiddle;
          data.data.nameLast = data.data.NameLast;
          delete data.data.NameLast;
          data.data.nameSuffix = data.data.NameSuffix;
          delete data.data.NameSuffix;
          data.data.licenceId = data.data.LicenceId;
          delete data.data.LicenceId;
          // data.data.license = data.data.License; delete data.data.License;
          data.data.dateOfBirth4 = data.data.DateOfBirth4;
          delete data.data.DateOfBirth4;
          data.data.dateOfBirth = data.data.DateOfBirth;
          delete data.data.DateOfBirth;
          data.data.dateOfBirthLocal = data.data.DateOfBirthLocal;
          delete data.data.DateOfBirthLocal;
          data.data.issueDate4 = data.data.IssueDate4;
          delete data.data.IssueDate4;
          data.data.issueDate = data.data.IssueDate;
          delete data.data.IssueDate;
          data.data.issueDateLocal = data.data.IssueDateLocal;
          delete data.data.IssueDateLocal;
          data.data.expirationDate4 = data.data.ExpirationDate4;
          delete data.data.ExpirationDate4;
          data.data.expirationDate = data.data.ExpirationDate;
          delete data.data.ExpirationDate;
          data.data.eyeColor = data.data.Eyes;
          delete data.data.Eyes;
          data.data.hairColor = data.data.Hair;
          delete data.data.Hair;
          data.data.height = data.data.Height;
          delete data.data.Height;
          data.data.weight = data.data.Weight;
          delete data.data.Weight;
          data.data.address = data.data.Address;
          delete data.data.Address;
          data.data.address2 = data.data.Address2;
          delete data.data.Address2;
          data.data.address3 = data.data.Address3;
          delete data.data.Address3;
          data.data.address4 = data.data.Address4;
          delete data.data.Address4;
          data.data.address5 = data.data.Address5;
          delete data.data.Address5;
          data.data.address6 = data.data.Address6;
          delete data.data.Address6;
          data.data.city = data.data.City;
          delete data.data.City;
          data.data.zip = data.data.Zip;
          delete data.data.Zip;
          data.data.state = data.data.State;
          delete data.data.State;
          data.data.county = data.data.County;
          delete data.data.County;
          data.data.countryShort = data.data.CountryShort;
          delete data.data.CountryShort;
          data.data.idCountry = data.data.IdCountry;
          delete data.data.IdCountry;
          data.data.licenceId = data.data.Id;
          delete data.data.Id;
          data.data.licenceClass = data.data.Class;
          delete data.data.Class;
          data.data.restriction = data.data.Restriction;
          delete data.data.Restriction;
          data.data.sex = data.data.Sex;
          delete data.data.Sex;
          data.data.audit = data.data.Audit;
          delete data.data.Audit;
          data.data.endorsements = data.data.Endorsements;
          delete data.data.Endorsements;
          data.data.fee = data.data.Fee;
          delete data.data.Fee;
          //data.data.CSC
          data.data.sigNum = data.data.SigNum;
          delete data.data.SigNum;
          data.data.text1 = data.data.Text1;
          delete data.data.Text1;
          data.data.text2 = data.data.Text2;
          delete data.data.Text2;
          data.data.text3 = data.data.Text3;
          delete data.data.Text3;
          data.data.type = data.data.Type;
          delete data.data.Type;
          data.data.docType = data.data.DocType;
          delete data.data.DocType;
          data.data.fatherName = data.data.FatherName;
          delete data.data.FatherName;
          data.data.motherName = data.data.MotherName;
          delete data.data.MotherName;
          data.data.nameFirst_NonMRZ = data.data.NameFirst_NonMRZ;
          delete data.data.NameFirst_NonMRZ;
          data.data.nameLast_NonMRZ = data.data.NameLast_NonMRZ;
          delete data.data.NameLast_NonMRZ;
          data.data.nameLast1 = data.data.NameLast1;
          delete data.data.NameLast1;
          data.data.nameLast2 = data.data.NameLast2;
          delete data.data.NameLast2;
          data.data.nameMiddle_NonMRZ = data.data.NameMiddle_NonMRZ;
          delete data.data.NameMiddle_NonMRZ;
          data.data.nameSuffix_NonMRZ = data.data.NameSuffix_NonMRZ;
          delete data.data.NameSuffix_NonMRZ;
          data.data.documentDetectedName = data.data.DocumentDetectedName;
          delete data.data.DocumentDetectedName;
          data.data.nationality = data.data.Nationality;
          delete data.data.Nationality;
          data.data.original = data.data.Original;
          delete data.data.Original;
          data.data.placeOfBirth = data.data.PlaceOfBirth;
          delete data.data.PlaceOfBirth;
          data.data.placeOfIssue = data.data.PlaceOfIssue;
          delete data.data.PlaceOfIssue;
          data.data.socialSecurity = data.data.SocialSecurity;
          delete data.data.SocialSecurity;
          data.data.isAddressCorrected = data.data.IsAddressCorrected;
          delete data.data.IsAddressCorrected;
          data.data.isAddressVerified = data.data.IsAddressVerified;
          delete data.data.IsAddressVerified;
          data.data.isBarcodeRead = data.data.IsBarcodeRead;
          delete data.data.IsBarcodeRead;
          data.data.isIDVerified = data.data.IsIDVerified;
          delete data.data.IsIDVerified;
          data.data.isOcrRead = data.data.IsOcrRead;
          delete data.data.IsOcrRead;
          data.data.documentVerificationRating =
            data.data.DocumentVerificationConfidenceRating;
          delete data.data.DocumentVerificationConfidenceRating;
        ...
        AcuantWinRT.API.Passport.processPassport().then(function(result) {
          ...
          data["id"] = "didFinishProcessingCardWithResult";
          data["data"] = JSON.parse(result);
          data.data.passportImage = arrayBufferToBase64(
            data.data.ReformattedImage
          );
          delete data.data.ReformattedImage;
          data.data.faceImage = arrayBufferToBase64(data.data.FaceImage);
          ...
          data.data.nameLast = data.data.NameLast;
          delete data.data.NameLast;
          data.data.passportNumber = data.data.PassportNumber;
          delete data.data.PassportNumber;
          data.data.personalNumber = data.data.PersonalNumber;
          delete data.data.PersonalNumber;
          data.data.sex = data.data.sex;
          delete data.data.Sex;
          data.data.countryLong = data.data.CountryLong;
          delete data.data.CountryLong;
          data.data.nationalityLong = data.data.NationalityLong;
          delete data.data.NationalityLong;
          data.data.dateOfBirth4 = data.data.DateOfBirth4;
          delete data.data.DateOfBirth4;
          data.data.issueDate4 = data.data.IssueDate4;
          delete data.data.IssueDate4;
          data.data.expirationDate4 = data.data.ExpirationDate4;
          delete data.data.ExpirationDate4;
          data.data.end_POB = data.data.End_POB;
          delete data.data.End_POB;
